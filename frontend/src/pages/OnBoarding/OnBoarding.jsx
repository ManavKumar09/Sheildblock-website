...
const CLOUD_STEPS = [
  {
    id: 1, label: 'Select Your Profile', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
...
const profilePresets = [
  {
    id: 'android',
    label: 'Android',
    desc: 'Protect your Android smartphones and tablets',
    icon: (
  ...
  },
  {
    id: 'ios',
    label: 'iOS',
    desc: 'Filter traffic on your iPhone and iPad',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    id: 'windows10',
    label: 'Windows 10/11+',
    desc: 'Secure your modern Windows desktop devices',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    id: 'macos',
    label: 'MacOS',
    desc: 'Block ads and trackers on your Mac',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    id: 'linux',
    label: 'Linux',
    desc: 'Privacy and security for your Linux machines',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
  ...
  {
    id: 'older_os',
    label: 'Router/Older Windows & Mac',
    desc: 'Legacy profiles for older operating systems',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <rect x="4" y="4" width="16" height="12" rx="1" stroke="currentColor" strokeWidth="1.8" />
...
export default function Onboarding() {
  ...
  const goNext = async () => {
    ...
    else navigate(isCloud ? '/dashboard' : '/')
  }
    ...
    <div className="onboard">
          ...
          <>
            ...
            {step === 1 && (
              <div className="onboard__body">
                <h2 className="onboard__title">Select your profile</h2>
                <p className="onboard__desc">
                  Select a filtering profile.
                </p>
          ...
          <>
              ...
              <div className="onboard__body">
                ...
                <div className="onboard__connect-steps">
                  {[
                    ...
                    { num: 2, title: 'Connect Ethernet', desc: "Plug an Ethernet cable from your router to the Raspberry Pi." },
            ...
            {step === 3 && (
              <div className="onboard__body onboard__body--center">
                ...
                <p className="onboard__complete-hint">
                  Head to the home page to explore more features.
                </p>
              </div>
            )}
          </>
      ...
      <div className="onboard__nav">
        ...
        <button className="onboard__next-btn" onClick={goNext} disabled={isLoading}>
          {isLoading ? 'Creating...' : (step === STEPS.length ? (isCloud ? 'Go to Dashboard' : 'Go to Home Page') : 'Continue')}
          {!isLoading && (
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
